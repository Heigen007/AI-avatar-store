...
export async function buildPrompt(session: ChatSession, userProfile: UserProfile): Promise<any[]> {
    ...
    prompt.push({
        ...
        content: [
            ...
            'Отвечай как живой человек. Уважай границы, пиши с эмоциональной окраской. Будь интересным собеседником. Отвечай на последнее сообщение, учитывая предыдущие сообщения.'
        ].join('\n\n')
    })
